package net.rikkalab.forge.client.renderer;
...
public class GlStateManager {
    ...
    public static void blendFunc(int sfactor, int dfactor) {
        if (sfactor != blendState.srcFactor || dfactor != blendState.dstFactor) {
            blendState.srcFactor = sfactor;
            blendState.dstFactor = dfactor;
    ...
    public static void texGen(TexGen texGen, int param) {
        TexGenCoord lvt_2_1_ = texGenCoord(texGen);
        if (param != lvt_2_1_.param) {
            lvt_2_1_.param = param;
            GL11.glTexGeni(lvt_2_1_.coord, 9472, param);
        }
    ...
    public static void deleteTexture(int texture) {
        ...
        for(int var3 = 0; var3 < var2; ++var3) {
            TextureState lvt_4_1_ = var1[var3];
            if (lvt_4_1_.textureName == texture) {
    ...
    public static FloatBuffer quatToGlMatrix(FloatBuffer p_187418_0_, Quaternion p_187418_1_) {
        p_187418_0_.clear();
        float lvt_2_1_ = p_187418_1_.x * p_187418_1_.x;
        float lvt_3_1_ = p_187418_1_.x * p_187418_1_.y;
        float lvt_4_1_ = p_187418_1_.x * p_187418_1_.z;
        float lvt_5_1_ = p_187418_1_.x * p_187418_1_.w;
        float lvt_6_1_ = p_187418_1_.y * p_187418_1_.y;
        float lvt_7_1_ = p_187418_1_.y * p_187418_1_.z;
        float lvt_8_1_ = p_187418_1_.y * p_187418_1_.w;
        float lvt_9_1_ = p_187418_1_.z * p_187418_1_.z;
        float lvt_10_1_ = p_187418_1_.z * p_187418_1_.w;
        p_187418_0_.put(1.0F - 2.0F * (lvt_6_1_ + lvt_9_1_));
        p_187418_0_.put(2.0F * (lvt_3_1_ + lvt_10_1_));
        p_187418_0_.put(2.0F * (lvt_4_1_ - lvt_8_1_));
        p_187418_0_.put(0.0F);
        p_187418_0_.put(2.0F * (lvt_3_1_ - lvt_10_1_));
        p_187418_0_.put(1.0F - 2.0F * (lvt_2_1_ + lvt_9_1_));
        p_187418_0_.put(2.0F * (lvt_7_1_ + lvt_5_1_));
        p_187418_0_.put(0.0F);
        p_187418_0_.put(2.0F * (lvt_4_1_ + lvt_8_1_));
        p_187418_0_.put(2.0F * (lvt_7_1_ - lvt_5_1_));
        p_187418_0_.put(1.0F - 2.0F * (lvt_2_1_ + lvt_6_1_));
        p_187418_0_.put(0.0F);
        p_187418_0_.put(0.0F);
        p_187418_0_.put(0.0F);
        p_187418_0_.put(0.0F);
    ...
    public static void glTexCoordPointer(int size, int type, int stride, int pointer_buffer_offset) {
        GL11.glTexCoordPointer(size, type, stride, (long)pointer_buffer_offset);
    }
    ...
    public static void glVertexPointer(int size, int type, int stride, int pointer_buffer_offset) {
        GL11.glVertexPointer(size, type, stride, (long)pointer_buffer_offset);
    }
    ...
    public static void glColorPointer(int size, int type, int stride, int pointer_buffer_offset) {
        GL11.glColorPointer(size, type, stride, (long)pointer_buffer_offset);
    }
