...
public abstract class Optional<T> implements Serializable {
  ...
  /**
   * Returns the equivalent {@code net.rikkalab.guava21.common.base.Optional} value to the given {@code
   ...
   * net.rikkalab.guava21.common.base.Optional}, or {@code null} if the argument is null.
   *
