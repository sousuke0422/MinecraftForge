...
public class CoreModManager {
    ...
    private static String[] rootPlugins = { "cpw.mods.fml.relauncher.FMLCorePlugin", "net.minecraftforge.classloading.FMLForgePlugin", "net.rikkalab.forge.core.FMLFMForgePlugin" };
